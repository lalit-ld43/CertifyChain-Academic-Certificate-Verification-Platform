          ...
          <div className="flex items-center gap-3">
            <div className="rounded-full bg-accent-100 p-2 text-accent-600 dark:bg-accent-900/30">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm-2.001 20.957v-6.957h-3.999v6.52c-2.457-.965-4.498-2.73-5.599-5.02h6.598v-3.5h-7.616c-.227-1.025-.383-2.091-.383-3.2 0-3.666 1.706-6.945 4.364-9.066v9.066h3.999v-6.619c2.306-1.037 5.031-1.038 7.338-.002v6.621h4.001v-9.065c2.657 2.122 4.363 5.401 4.363 9.066 0 1.109-.156 2.175-.383 3.2h-7.617v3.5h6.598c-1.102 2.29-3.142 4.055-5.599 5.02v-6.52h-4.001v6.957c-.649.096-1.317.15-2.001.15-.683 0-1.35-.054-1.999-.15z" />
              </svg>
            </div>
            <h3 className="text-lg font-bold text-primary-900 dark:text-white font-display">
              CertifyChain Browser Extension
            </h3>
          </div>
          <p className="mt-2 text-sm text-primary-600 text-center max-w-md dark:text-primary-400">
            Verify credentials directly inline on LinkedIn, Indeed, and applicant tracking systems
