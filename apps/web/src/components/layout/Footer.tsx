        ...
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-primary-500">
              <li><Link to="/verify" className="hover:text-accent-600">Verify a certificate</Link></li>
              <li><Link to="/institutions" className="hover:text-accent-600">Institutions</Link></li>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-primary-500">
              <li><Link to="/privacy" className="hover:text-accent-600">Privacy Policy</Link></li>
              <li><Link to="/terms" className="hover:text-accent-600">Terms of Service</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="text-sm font-semibold text-primary-800 dark:text-white">Community</h3>
            <ul className="mt-3 space-y-2 text-sm text-primary-500">
              <li><Link to="/feedback" className="hover:text-accent-600">Give feedback</Link></li>
            </ul>
          </div>
        </div>
