...
|---|---|---|---|---|---|---|
| 2 | Priya Patel | priyapatel23@gmail.com | `GDL4OXKWU6BBQN35SBDSXDZ7R6I7TGN4HU5MPTWS4TF4Z3EE2AISHSNB` | Mobile responsiveness could be slightly improved | UI: improve mobile responsiveness for wallet connection buttons | [`83a3d8a`](https://github.com/lalit-ld43/CertifyChain-Academic-Certificate-Verification-Platform/commit/83a3d8a6b15e8de47fc8e3506367fd566c80d2a5) |
| 4 | Sneha Reddy | snehareddy77@gmail.com | `GBQWNA5TWDQKS52MYIBHTRGSWXF2XIHNSAWWXVWJPCDJGUSEACUIUX4K` | Faster loading times on the initial login screen | Perf: preconnect fonts to improve initial login screen load time | [`4b2f361`](https://github.com/lalit-ld43/CertifyChain-Academic-Certificate-Verification-Platform/commit/4b2f3610eb29de285e7aa8092f54f2648f2acfaa) |
| 6 | Neha Gupta | nehagupta98@gmail.com | `GDJ6W3GKEXOGVVKIVPWG6YYPQDAWKPXT6ZNMIYN677HBIXEXDIMAYOL6` | Better error messages when rate limits hit | Feat: improve rate limit error message with specific wait time | [`bd30f29`](https://github.com/lalit-ld43/CertifyChain-Academic-Certificate-Verification-Platform/commit/bd30f29f1163ef2b2f64cb22399d39d9d6da02af) |
| 12 | Pooja Rao | poojarao11@gmail.com | `GDVLOTDKR4W2UIEVN6NXIQSPP2H3FX2ECVX6Z4FOD3QIODRRILNSFDVX` | Allow custom notification alerts for status changes | Feat: add detailed custom notification alerts for wallet status changes | [`83a3d8a`](https://github.com/lalit-ld43/CertifyChain-Academic-Certificate-Verification-Platform/commit/83a3d8a6b15e8de47fc8e3506367fd566c80d2a5) |
| 13 | Anil Kapoor | anilkapoor88@gmail.com | `GCECGSB7HOIOTGAZ7WDXJF3PXDPVF35MFKTNREOBYUPRCW47J6V5UQIM` | simplify the wallet connection process for beginners | UI: simplify wallet connection with beginner-friendly helper text | [`83a3d8a`](https://github.com/lalit-ld43/CertifyChain-Academic-Certificate-Verification-Platform/commit/83a3d8a6b15e8de47fc8e3506367fd566c80d2a5) |
| 48 | Suresh Patel | sureshpatel993@gmail.com | `GBR3IB4NC2CVCPIRXDEMECXO63G77YHBZPMSUSAK6F4FJTP6MPMM4ZVV` | Institution reputation scoring would help users distinguish trustworthy credential issuers quickly | UI: Add Reputation Score badge to institutions | [`97e3408`](https://github.com/lalit-ld43/CertifyChain-Academic-Certificate-Verification-Platform/commit/97e3408) |
| 38 | Himanshu Jha | jhahimanshu653@gmail.com | `GCQDS22F2XRAVI6H2HK6U65PDVMG7QDQEDIAPWE4NLMF7VBEB5SW5BRY` | AI auto-extraction of certificate details before upload would cut manual data entry drastically | Feat: Add AI Auto-Extract button to credential form | [`cb7a897`](https://github.com/lalit-ld43/CertifyChain-Academic-Certificate-Verification-Platform/commit/cb7a897) |
| 56 | Geeta Bhat | geetabhat770@gmail.com | `GCPBXGWSA53B2ANFVCZTVFTM2WQ3UPWNH3V57JV76ZQ2RE3KRIPSHZRV` | Student mobile app for on-the-go credential sharing would be a game changer for Gen Z users | UI: Add Mobile App download banner to student dashboard | [`511df19`](https://github.com/lalit-ld43/CertifyChain-Academic-Certificate-Verification-Platform/commit/511df19) |
| 50 | Khushi Singh | singhkhushi0719@gmail.com | `GAJ3RYDSIPPYICTKLSUHOCJBLXLDFIKT5KL2HAFXLC4EB7TOTNUSVHKY` | A public credential timeline would double as a compelling visual portfolio for job seekers | Feat: Add Audit Logs (Timeline) to credential view | [`e2c31b0`](https://github.com/lalit-ld43/CertifyChain-Academic-Certificate-Verification-Platform/commit/e2c31b0) |
| 57 | Ashok Tiwari | ashoktiwari2001@gmail.com | `GDZSVQVKUYHN6JTAEFCRFK6DJYL7FT7JF3SDC2RVRFTHME2BNTA34CR2` | A customizable digital credential card for professionals would serve as a great shareable profile | UI: Add Digital Credential Card sharing button | [`e2c31b0`](https://github.com/lalit-ld43/CertifyChain-Academic-Certificate-Verification-Platform/commit/e2c31b0) |
| 59 | Preeti Kumari | preeimehta776@gmail.com | `GC7STYZF73KE75D6QHRMQ5Y76ITVWUK3NVGOLCLSOQV3YJFWYIHPPLUD` | Browser extension to verify credentials inline without switching tabs would fit perfectly into hiring flows | Feat: Add Browser Extension Prompt to verify landing page | [`ead8792`](https://github.com/lalit-ld43/CertifyChain-Academic-Certificate-Verification-Platform/commit/ead8792) |
| 39 | Akash Mondal | 73akash58mondal@gmail.com | `GA7OQQKXRECE47DRYHRFI2BSFWNIXIKOXOSVF2AFNDKXQDTGPORXDACX` | Institution credential analytics dashboard would help universities improve placement outcomes | Feat: Add Analytics Dashboard Summary to institution page | [`6ecd6be`](https://github.com/lalit-ld43/CertifyChain-Academic-Certificate-Verification-Platform/commit/6ecd6be) |
| 54 | Rekha Nair | rekhanair34@gmail.com | `GDX3LKGZAPR477BMS4DS3PLGM3KGE44DQINNBD2KY6FMCKT2FP2LYBXE` | Credential type templates for degrees and licenses would help institutions issue records faster | UI: Add Simple Mode toggle for non-technical users | [`eda2bbd`](https://github.com/lalit-ld43/CertifyChain-Academic-Certificate-Verification-Platform/commit/eda2bbd) |
